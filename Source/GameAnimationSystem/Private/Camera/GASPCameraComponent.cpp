...
UGASPCameraComponent::UGASPCameraComponent()
{
	...
	static ConstructorHelpers::FObjectFinder<USkeletalMesh> CameraMeshAsset(
		TEXT("/GameAnimationSystem/Camera/SKM_MatineeCamera.SKM_MatineeCamera")
	);
	...
	static ConstructorHelpers::FClassFinder<UAnimInstance> ABP_Camera(
		TEXT("/GameAnimationSystem/Camera/ABP_GASPCamera.ABP_GASPCamera_C")
	);
	...
	static ConstructorHelpers::FObjectFinder<UGASPCameraSettings> CameraSettingsAsset(
		TEXT("/GameAnimationSystem/Camera/DA_CameraSettings.DA_CameraSettings")
	);
	if (CameraSettingsAsset.Succeeded()) { CameraSettings = CameraSettingsAsset.Object; }
}

void UGASPCameraComponent::GetLifetimeReplicatedProps(TArray<FLifetimeProperty>& OutLifetimeProps) const
{
	Super::GetLifetimeReplicatedProps(OutLifetimeProps);

	DOREPLIFETIME_CONDITION(UGASPCameraComponent, ViewMode, COND_OwnerOnly);
}

void UGASPCameraComponent::PostLoad()
{
	Super::PostLoad();
...
void UGASPCameraComponent::OnRegister()
{
	Super::OnRegister();
...
void UGASPCameraComponent::Activate(bool bReset)
{
...
void UGASPCameraComponent::RegisterComponentTickFunctions(bool bRegister)
{
...
void UGASPCameraComponent::BeginPlay()
{
	Super::BeginPlay();
...
void UGASPCameraComponent::TickComponent(float DeltaTime, ELevelTick TickType, FActorComponentTickFunction* ThisTickFunction)
{
...
void UGASPCameraComponent::CompleteParallelAnimationEvaluation(bool bDoPostAnimationEvaluation)
{
...
#pragma optimize("", off)
void UGASPCameraComponent::TickCamera(float DeltaTime, bool bAllowLag)
{
...
FRotator UGASPCameraComponent::CalcCameraRotation(const FRotator& CameraTargetRotation, float DeltaTime, bool bAllowLag) const
{
...
FVector UGASPCameraComponent::CalcPivotLagLocation(const FQuat& CameraYawRotation, float DeltaTime, bool bAllowLag) const
{
...
FVector UGASPCameraComponent::CalcCollisionFixLocation(const FVector& CameraTargetLocation, const FVector& PivotOffset, float DeltaTime, bool bAllowLag, float& NewTraceDistanceRatio) const
{
...
bool UGASPCameraComponent::TryAdjustTraceStartLocation(FVector& Location, float MeshScale) const
{
...
* Public APIs
*/
void UGASPCameraComponent::GetViewInfo(FMinimalViewInfo& ViewInfo) const
{
...
void UGASPCameraComponent::SetViewMode(EGASPViewMode NewViewMode, bool bForce)
{
...
void UGASPCameraComponent::Server_SetViewMode_Implementation(EGASPViewMode NewViewMode)
{
	ViewMode = NewViewMode;
}

void UGASPCameraComponent::SetShoulderMode(EGASPShoulderMode NewShoulderMode, bool bForce)
{
